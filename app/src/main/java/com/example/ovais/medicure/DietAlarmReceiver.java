...
//            if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED")) {
        ...
        Intent notificationIntent = new Intent(context, DietAlertActivity.class);

        Notification notification = new NotificationCompat.Builder(context)
                .setContentTitle("Diet Alert")
                .setContentText("You have a diet to take!")
                .setSmallIcon(R.mipmap.ic_launcher_round)
                .setContentIntent(PendingIntent.getActivity(context, 0, new Intent(context, DietAlertActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
                .build();
