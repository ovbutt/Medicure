...
//            if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED")) {
        ...
        Intent notificationIntent = new Intent(context, MedicineAlertActivity.class);

        Notification notification = new NotificationCompat.Builder(context)
                .setContentTitle("Medicine Alert")
                .setContentText("You have a medicine to take!")
                .setSmallIcon(R.mipmap.ic_launcher_round)
                .setContentIntent(PendingIntent.getActivity(context, 0, new Intent(context, MedicineAlertActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
                .build();
